# Graph Report - cftvpro-cpz  (2026-08-20)

## Corpus Check
- 3 files · ~29,586 words
...
7. `start_url` - 1 edges
8. `display` - 1 edges
9. `background_color` - 1 edges
10. `theme_color` - 1 edges
...
## Knowledge Gaps
- **26 isolated node(s):** `ASSETS`, `name`, `short_name`, `description`, `start_url` (+21 more)
...
- **What connects `ASSETS`, `name`, `short_name` to the rest of the system?**
